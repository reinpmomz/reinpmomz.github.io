...
over_sampling <-ovun.sample(stroke ~.,data=train, method = "over", N=7518)$data
...
From the output above, we can see that sensitivity is still 0% while specificity has gone down to 99.78%. This proportion is not still good.
...
under_sampling <-ovun.sample(stroke ~.,data=train, method = "under", N=334)$data
...
From the output above, sensitivity now stands at 78.57% while specificity stands at 73.29%. This is a better model than the unbalanced and over sampled model.
